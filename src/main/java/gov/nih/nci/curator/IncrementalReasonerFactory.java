 ...
 * @author Evren Sirin
 */
public class IncrementalReasonerFactory implements OWLReasonerFactory {
	private static final IncrementalReasonerFactory INSTANCE = new IncrementalReasonerFactory();
	 ...
	 */
	public static IncrementalReasonerFactory getInstance() {
		return INSTANCE;
	}
