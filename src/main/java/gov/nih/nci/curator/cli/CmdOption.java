...
public class CmdOption {
	...
	private CmdOptionArg	arg	= CmdOptionArg.NONE;

	public CmdOption(String longOption) {
		if( longOption == null )
	 ...
	 */
	public int getValueAsNonNegativeInteger() throws CmdException {
	 ...
	 */
	public int getValueAsInteger(int minAllowed, int maxAllowed) throws CmdException {
		String value = getValueAsString();

		if( value == null ) {
			throw new CmdException( String.format(
	...
	public void setArg(CmdOptionArg arg) {
		this.arg = arg;
	}

	public CmdOptionArg getArg() {
		return arg;
	}
